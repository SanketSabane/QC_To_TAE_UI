...
import com.automationTest.operations.AddRemoveProductFromCart;
...
public class ProductAddRemoveFromCartTest extends BaseTest 

{
	...
	public void AddRemoveProductFromCartFeature () throws Exception {
		
		LoginUser loginuser = TestOperationFactory.getOperation(LoginUser.class);
		loginuser.LoginUserFeature();
		
		AddRemoveProductFromCart addremoveproductfromcart= TestOperationFactory.getOperation(AddRemoveProductFromCart.class);
		addremoveproductfromcart.AddRemoveProductFeature();
