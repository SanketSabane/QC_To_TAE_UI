...
public class old_LandingPage extends BasePage implements TestPage {
	...
	public old_LandingPage(WebDriver driver) throws DriverNotInitializedException {
		super(driver);
	}

	
	
	public old_LandingPage clickFlight() {
		wait.until(ExpectedConditions.visibilityOf(Flights));
		Flights.click();
		return this;
	}
	
	public old_LandingPage selectOneWay() {
	...
	public old_LandingPage EnterFrom(String from) {
	...
	public old_LandingPage EnterTo(String ToLoc) {
	...
	public old_LandingPage EnterDepartureDate(String Date) {
